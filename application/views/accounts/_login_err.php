<div class="login-box">
  ...
  <div class="login-box-body">
    <div class="callout callout-danger" id="info_callout">
      <h4>Login Error,</h4>

      <p>There is a problem with your login, please try again!</p>
    </div>
...
<script>
  $(function () {
    ...
    $(".form-control").on('hover',function(e) {
      console.log("Hello you");
      $("#info_callout").delay(10000).fadeOut("slow");
    });
    $("#info_callout").delay(10000).fadeOut("slow");
  });
</script>